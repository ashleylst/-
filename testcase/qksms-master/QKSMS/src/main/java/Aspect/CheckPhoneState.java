...
/**
 * Created by ke on 2017/5/24 0024.
 */
 ...
 */
@Aspect
public class CheckPhoneState {

    private String fileName="D:\\phonestate.txt";

    private String Tag = "ReadPhoneState";

    //private boolean flag = true;

    @Pointcut("call (* android.telephony..*(..)) || call (* android.content.Intent..*(..)) || call(* android.content.Context.getSystemService(..))&& !within(CheckPhoneState) ")
    ...
    public void CheckBefore(JoinPoint thisJoinPoint){
        ...
        try{
            ...
            out.write("source location: " + srcName + " classname: " + className + " methodname: " + methodName);
            out.newLine();
            out.close();
        }catch (IOException e)
        {
